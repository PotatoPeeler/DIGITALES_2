...
ARCHITECTURE structure OF DECO_HEX IS
...
-- Equation(s):
-- \Mux3~0_combout\ = (\C~input_o\ & ((\D~input_o\ & ((\B~input_o\))) # (!\D~input_o\ & (\A~input_o\ & !\B~input_o\)))) # (!\C~input_o\ & (!\A~input_o\ & (\D~input_o\ $ (\B~input_o\))))
