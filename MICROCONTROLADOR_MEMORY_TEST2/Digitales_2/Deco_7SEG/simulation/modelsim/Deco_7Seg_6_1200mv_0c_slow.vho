...
-- A	=>  Location: PIN_AA1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF Deco_7Seg IS
...
-- Equation(s):
-- \Mux6~0_combout\ = (!\A~input_o\ & (!\B~input_o\ & !\C~input_o\))
...
-- Equation(s):
-- \Mux3~0_combout\ = (\A~input_o\ & (((\B~input_o\) # (\C~input_o\)))) # (!\A~input_o\ & (\B~input_o\ $ (((\D~input_o\ & !\C~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1111110011010010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \D~input_o\,
...
-- Equation(s):
-- \Mux1~0_combout\ = (\A~input_o\ & (((\B~input_o\) # (\C~input_o\)))) # (!\A~input_o\ & (\B~input_o\ & (\D~input_o\ $ (\C~input_o\))))
